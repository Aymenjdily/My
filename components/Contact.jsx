  ...
  return (
    <section className='container mx-auto py-[100px] px-10' id="contact">
        <div className='flex flex-col items-center justify-center gap-[30px]'>
            ...
            <motion.h1 initial={{ opacity:0, scale: 0.8}} transition={{ duration: 0.5}} whileInView={{ opacity:1 , scale: 1}} className='lg:text-[124px] md:text-[100px] text-[50px] font-lilita'>
                Let&#39;s Talk
            </motion.h1>
